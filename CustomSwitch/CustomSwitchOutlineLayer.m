//
//  CustomSwitchOutlineLayer.m
//
//  Created by jason on 12/11/10.
//  Copyright (c) 2011 none. All rights reserved.
//
//  baded on DCRoundSwitchOutlineLayer.m Created by Patrick Richards on 29/06/11.
//  MIT License.
//  http://github.com/domesticcatsoftware/DCRoundSwitch

#import "CustomSwitchOutlineLayer.h"

@implementation CustomSwitchOutlineLayer
...
- (void)drawInContext:(CGContextRef)context
{
	...
	UIBezierPath *outlinePath = [UIBezierPath bezierPathWithRoundedRect:CGRectOffset(self.bounds, -0.5, 0.0) 
